from FLAlgorithms.users.useravghkd import UserAVGhkd
...
class FedAvghkd(Server):
    def __init__(self, args, model, seed):
        ...
        for i in range(total_users):
            ...
            user = UserAVGhkd(args, id, model, train_data, test_data, use_adam=False)
    ...
    def train(self, args):
        ...
        for glob_iter in range(self.num_glob_iters):
            ...
            for user in self.selected_users: # allow selected users to train
                w, loss,acc= user.train(glob_iter,
                                        global_weights,
            ...
            # print('Average local loss:',loss_avg)
