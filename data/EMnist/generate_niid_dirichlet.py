...
def main():
    ...
    parser.add_argument("--n_class", type=int, default=26, help="number of classification labels")    #5
    ...
    parser.add_argument("--sampling_ratio", type=float, default=0.8, help="Ratio for sampling training samples.")
    ...
    def process_user_data(mode, data, n_sample, SRC_CLASSES, Labels=None, unknown_test=0):
        ...
        for i in range(NUM_USERS):
            ...
            dataset['user_data'][uname]={
                ...
                'y': torch.tensor(y[i], dtype=torch.float32)}     #原来dtype=torch.int64
