...
SAMPLE="niid" # -s tag, iid or niid
IUSER="" # --iu tag, # of users if iid sampling
SFRAC="1.0" # --sf tag, fraction of data to sample
MINSAMPLES="5" # -k tag, minimum allowable # of samples per user
TRAIN="sample" # -t tag, user or sample
